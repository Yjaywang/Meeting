...
const PasswordInput: React.FC<PasswordInputProps> = (props) => {
  ...
  function toggleSeeOldPWHandler() {
    ...
    if (pwOldInputContainerEl) {
      const passwordInputEl =
        pwOldInputContainerEl.querySelector(".template-input") as HTMLInputElement | null;
      if (passwordInputEl) {
        if (!seeOldPW) {
  ...
  function toggleSeeNewPWHandler() {
    ...
    if (pwNewInputContainerEl) {
      const passwordInputEl =
        pwNewInputContainerEl.querySelector(".template-input") as HTMLInputElement | null;
      if (passwordInputEl) {
        if (!seeNewPW) {
          passwordInputEl.type = "text";
        } else {
  ...
  function toggleSeeCheckPWHandler() {
    ...
    if (pwCheckInputContainerEl) {
      const passwordInputEl =
        pwCheckInputContainerEl.querySelector(".template-input") as HTMLInputElement | null;
      if (passwordInputEl) {
        if (!seeCheckPW) {
          passwordInputEl.type = "text";
        } else {
